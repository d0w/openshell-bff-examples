// AuditHandler is a downstream-only capability that doesn't exist in
...
func NewAuditHandler(svc upstreamservices.SandboxService) *AuditHandler {
	return &AuditHandler{sandboxService: svc}
}
...
func (h *AuditHandler) SandboxStats(w http.ResponseWriter, r *http.Request) {
